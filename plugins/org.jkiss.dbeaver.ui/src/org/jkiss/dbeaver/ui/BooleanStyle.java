...
public class BooleanStyle {
    ...
    private final BooleanAlignment alignment;
    private final RGB color;

    private BooleanStyle(@NotNull BooleanMode mode, @Nullable String text, @Nullable DBIcon icon, @NotNull BooleanAlignment alignment, @Nullable RGB color) {
        this.mode = mode;
        this.text = text;
        this.icon = icon;
    ...
    @NotNull
    public static BooleanStyle usingText(@NotNull String text, @NotNull BooleanAlignment alignment, @NotNull RGB color) {
        return new BooleanStyle(BooleanMode.TEXT, text, null, alignment, color);
    }

    @NotNull
    public static BooleanStyle usingIcon(@NotNull DBIcon icon, @NotNull BooleanAlignment alignment) {
    ...
    @NotNull
    public BooleanAlignment getAlignment() {
        return alignment;
    }
