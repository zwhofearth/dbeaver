    ...
    private static BooleanStyle getDefaultStyleLegacy(@NotNull DBPPreferenceStore store, @NotNull BooleanState state, @NotNull RGB color) {
        switch (store.getString(PREF_BOOLEAN_STYLE)) {
            case PROP_LEGACY_STYLE_ICON:
                return BooleanStyle.usingIcon(state.choose(UIIcon.CHECK_ON, UIIcon.CHECK_OFF, UIIcon.CHECK_QUEST), BooleanAlignment.CENTER);
            case PROP_LEGACY_STYLE_CHECKBOX:
                return BooleanStyle.usingText(state.choose("☑", "☐", "☒"), BooleanAlignment.CENTER, color);
            case PROP_LEGACY_STYLE_TRUE_FALSE:
                return BooleanStyle.usingText(state.choose("true", "false", DBConstants.NULL_VALUE_LABEL), BooleanAlignment.CENTER, color);
            case PROP_LEGACY_STYLE_YES_NO:
                return BooleanStyle.usingText(state.choose("yes", "no", DBConstants.NULL_VALUE_LABEL), BooleanAlignment.CENTER, color);
            case PROP_LEGACY_STYLE_TEXTBOX:
            default:
                return BooleanStyle.usingText(state.choose("[v]", "[ ]", DBConstants.NULL_VALUE_LABEL), BooleanAlignment.CENTER, color);
        }
    }
